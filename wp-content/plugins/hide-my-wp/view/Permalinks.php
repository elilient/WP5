                        ...
                        <div class="card-body py-2 px-0">
                            ...
                            <div class="group_autoload d-flex justify-content-center btn-group mt-3" role="group" data-toggle="button">
                                ...
                                <div style="position: relative; margin: .23rem!important;">
                                    <div class="box" style="border: none" data-toggle="popover" data-html="true" data-placement="top" data-content="<?php echo sprintf(__('Upgrade Your Website Security Protection. Hide WordPress Completely. %sUnlock this feature%s', _HMW_PLUGIN_NAME_), "<br /><a href='https://hidemywpghost.com/wordpress_update' target='_blank'>", "</a>") ?>">
