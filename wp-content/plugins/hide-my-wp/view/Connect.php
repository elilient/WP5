                        ...
                        <div class="col-sm-12 row mb-1 ml-1 hmw_howtolessons_div">
                            <div class="checker col-sm-12 row my-2 py-1">
                                <div class="col-sm-12 p-0 switch switch-sm">
                                    ...
                                    <label for="hmw_howtolessons"><?php _e('Send Setup Lessons', _HMW_PLUGIN_NAME_); ?></label>
                                    <div class="offset-1 text-black-50"><?php _e('I agree to receive How To email lessons to help me setup Hide My WP Ghost plugin.', _HMW_PLUGIN_NAME_); ?></div>
                                </div>
                            </div>
                        </div>
